...
$EndDescr
$Comp
L MT8816:MT8816_PLCC44 U?
U 1 1 64C58AC7
P 4225 3175
AR Path="/64C58AC7" Ref="U?"  Part="1" 
AR Path="/64C5439F/64C58AC7" Ref="U5"  Part="1" 
F 0 "U5" H 3525 4475 50  0000 C CNN
F 1 "MT8816" H 5025 4475 50  0000 C CNN
F 2 "Package_LCC:PLCC-44_THT-Socket" H 3325 4525 50  0001 C CIN
...
AR Path="/64C5439F/64C58B2A" Ref="U6"  Part="1" 
F 0 "U6" H 7275 4475 50  0000 C CNN
F 1 "MT8816" H 8775 4475 50  0000 C CNN
F 2 "Package_LCC:PLCC-44_THT-Socket" H 7075 4525 50  0001 C CIN
...
AR Path="/64C5439F/64C77EFC" Ref="#PWR074"  Part="1" 
F 0 "#PWR074" H 1825 2575 50  0001 C CNN
...
U 1 1 64C7A6C8
P 2000 2425
F 0 "#PWR073" H 2000 2275 50  0001 C CNN
...
U 1 1 64CC41DA
P 2925 3375
F 0 "#PWR075" H 2925 3225 50  0001 C CNN
...
AR Path="/64C5439F/64CC898E" Ref="#PWR077"  Part="1" 
F 0 "#PWR077" H 3200 3300 50  0001 C CNN
...
AR Path="/64C5439F/64CDC2E2" Ref="C9"  Part="1" 
F 0 "C9" H 4558 1604 50  0000 R CNN
...
AR Path="/64C5439F/64CDC2E8" Ref="#PWR070"  Part="1" 
F 0 "#PWR070" H 4650 1500 50  0001 C CNN
...
AR Path="/64C5439F/64CEE7DD" Ref="C10"  Part="1" 
F 0 "C10" H 8333 1604 50  0000 R CNN
...
AR Path="/64C5439F/64CEE7E7" Ref="#PWR071"  Part="1" 
F 0 "#PWR071" H 8425 1500 50  0001 C CNN
...
AR Path="/64C5439F/64CFA07C" Ref="C11"  Part="1" 
F 0 "C11" H 3200 3550 50  0000 R CNN
...
AR Path="/64C5439F/64CFA086" Ref="#PWR079"  Part="1" 
F 0 "#PWR079" H 3000 3400 50  0001 C CNN
...
U 1 1 64D12A34
P 6675 3375
F 0 "#PWR076" H 6675 3225 50  0001 C CNN
...
AR Path="/64C5439F/64D12A3E" Ref="#PWR078"  Part="1" 
F 0 "#PWR078" H 6950 3300 50  0001 C CNN
...
AR Path="/64C5439F/64D12A4B" Ref="C12"  Part="1" 
F 0 "C12" H 6950 3550 50  0000 R CNN
...
AR Path="/64C5439F/64D12A55" Ref="#PWR080"  Part="1" 
F 0 "#PWR080" H 6750 3400 50  0001 C CNN
...
U 1 1 64DF59FE
P 1825 2425
F 0 "#PWR072" H 1825 2275 50  0001 C CNN
...
U 1 1 64DFA811
P 4325 1550
F 0 "#PWR066" H 4325 1400 50  0001 C CNN
...
U 1 1 64E0D5FB
P 8425 1550
F 0 "#PWR069" H 8425 1400 50  0001 C CNN
...
U 1 1 64E0DD44
P 8075 1550
F 0 "#PWR068" H 8075 1400 50  0001 C CNN
